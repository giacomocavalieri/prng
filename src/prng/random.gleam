...
/// Returns a value randomly generated by the given generator.
/// 
...
/// with it.
/// 
/// `seed` is the initial seed used to start the generation sequence.
/// 
...
/// Returns a generator which produces floating point numbers in the given
/// inclusive range.
/// 
/// ## Examples
/// 
